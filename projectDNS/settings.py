"""
Django settings for projectDNS project.
...
# inport de variables de entorno (fichero .env)
...
#SECRET_KEY = 'django-insecure-mag3&!hj-*a5ybq72ybovhl#0+tc+xyhuas0fy+an2kmjjf7$%'
...
MIDDLEWARE = [
    ...
    'app.middleware.PermisoMiddleware'
]
...
WSGI_APPLICATION = 'projectDNS.wsgi.application'
...
# Especificar los directorios de archivos como CSS
STATICFILES_DIRS = [
    BASE_DIR / "static"
]